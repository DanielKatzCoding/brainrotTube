...
export function useVideoProgress() {
  ...
  if (!context)
    throw new Error(
      "useVideoProgress must be used within VideoProgressContext.Provider",
    );
  return context;
}
...
export function useVideoRef() {
  ...
  if (!context)
    throw new Error("useVideoRef must be used within VideoRefContext.Provider");
  return context;
}
  ...
  return (
    <VideoRefContext.Provider value={videoRef}>
      <VideoProgressContext.Provider
        value={{ progress, setProgress, duration, setDuration }}
      >
        {children}
      </VideoProgressContext.Provider>
